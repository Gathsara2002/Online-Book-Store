...
export function NavBar() {
    return (
        <section
            className={"container flex w-full border border-black h-20 align-middle fixed items-center top-0 right-0"}>
            ...
            <div className={"flex h-12 border border-red-600 mr-10"}>
